...
// short-circuits on all admin UI routes as a defense in depth measure so
// events never fire from admin UIs.
...
function isAdminPath(): boolean {
  ...
  return p === "/admin" || p.startsWith("/admin/") || p === "/admin-analytics";
}
