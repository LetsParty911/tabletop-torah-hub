          ...
          <div className="parchment-panel">
            ...
            <div className="mt-8 space-y-5 font-serif text-base sm:text-lg text-foreground leading-relaxed max-w-2xl mx-auto">
              ...
              <p>
                ...
                Yom Tov, alongside a growing archive of earlier weeks. Our mission is to help
                individuals and families strengthen their connection to Torah by making meaningful
                learning easier to access, print, and bring to the Shabbos table — for children,
            ...
            <div className="mt-10 pt-8 border-t-2 border-accent/30 space-y-8 max-w-2xl mx-auto text-left">
              ...
              <section>
                ...
                <ul className="mt-2 list-disc pl-6 space-y-1 font-serif text-base text-foreground leading-relaxed">
                  ...
                  <li>
                    Creates original educational materials, including Parsha Questions &amp;
                    Answers, Stories for the Shabbos Table, Short Vorts, and family discussion
                    questions
                  </li>
              ...
              <section>
                ...
                <p className="mt-3 font-serif text-base text-foreground leading-relaxed">
                  Torah For The Table does not charge visitors to access its educational materials.
                  Its activities are operated for religious, charitable, and educational purposes.
                </p>
              </section>
