...
import SimpleBannerForm from "@/components/admin/SimpleBannerForm";
...
function AdminPage() {
  ...
  const onReplaceFileInputChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        <section className="parchment-frame">
          <div className="parchment-panel">
            <PdfListSection
              ...
              onToggleShowAllPdfs={() => setShowAllPdfs((v) => !v)}
              yearFilter={yearFilter}
              onYearFilterChange={setYearFilter}
              checklistParshaComparableKey={checklistParshaComparableKey}
              jewishYear={jewishYear}
              toParshaComparableKey={toParshaComparableKey}
              descBulk={descBulk}
              onGenerateAllDescriptions={handleGenerateAllDescriptions}
              editingPdfId={editingPdfId}
              onStartEditPdf={startEditPdf}
              onCancelEditPdf={cancelEditPdf}
              ...
              onEditMetaSubtitleChange={setEditMetaSubtitle}
              editMetaDescription={editMetaDescription}
              onEditMetaDescriptionChange={setEditMetaDescription}
              editMetaAudience={editMetaAudience}
              onEditMetaAudienceChange={setEditMetaAudience}
              editMetaFeaturedSlot={editMetaFeaturedSlot}
              onEditMetaFeaturedSlotChange={setEditMetaFeaturedSlot}
              editMetaContentType={editMetaContentType}
              onEditMetaContentTypeChange={setEditMetaContentType}
              editMetaFormatType={editMetaFormatType}
              onEditMetaFormatTypeChange={setEditMetaFormatType}
              editMetaPageCount={editMetaPageCount}
              onEditMetaPageCountChange={setEditMetaPageCount}
              editMetaBadge={editMetaBadge}
              onEditMetaBadgeChange={setEditMetaBadge}
